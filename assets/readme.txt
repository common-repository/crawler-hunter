...
In addition, you can manually blacklist the ip address, you enable the automatic IP blocking option, IP addresses that make more than 5 requests in 1 minute will be blocked for 240 minutes  by default. You can change these values ​​here.
